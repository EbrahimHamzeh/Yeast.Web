...
namespace Yeast.Areas.Admin.Controllers
{
    public partial class CategoryController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Add = "~/Areas/Admin/Views/Category/Add.cshtml";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : Yeast.Areas.Admin.Controllers.CategoryController
    {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Yeast.Model.Admin.CategoryAdd model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(Yeast.Model.Admin.CategoryAdd model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
