...
// Resize	
function resize(){
	$('.resize-height').height(window.innerHeight - 500);
...
$("#newsletter-builder-sidebar-buttons-bbutton").click(function(){
    ...
    $("#export-textarea").val(preload_export_html)

	$.ajax({
        url: "../../Content/drag-and-drop-newsletter-builder-using-jquery/_css/newsletter.css"
	}).done(function(data) {
