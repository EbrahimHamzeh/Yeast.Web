...
namespace Yeast.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : Yeast.Areas.Admin.Controllers.UserController
    {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Yeast.DomainClasses.Entities.User model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(Yeast.DomainClasses.Entities.User model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
