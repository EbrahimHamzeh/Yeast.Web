...
namespace Yeast.Utilities.DynamicRoleBase
{
    /// <summary>
    ...
    public class ControllerHelper
    {
        ...
        public IEnumerable<ControllerDescription> GetControllersNameAnDescription(string filter = null)
        {
            ...
            var controllerList = (
                    ...
                    let attribute = (DescriptionAttribute)System.Attribute.GetCustomAttribute(controller, typeof(DescriptionAttribute))
