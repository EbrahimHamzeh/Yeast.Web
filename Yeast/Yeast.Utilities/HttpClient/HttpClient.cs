...
namespace Yeast.Utilities.HttpClient
{
    public class HttpClientFactory : IHttpClientFactory
    {
        ...
        private readonly ConcurrentDictionary<Uri, Lazy<System.Net.Http.HttpClient>> _httpClients =
                         new ConcurrentDictionary<Uri, Lazy<System.Net.Http.HttpClient>>();
        ...
        public System.Net.Http.HttpClient GetOrCreate(
           Uri baseAddress,
           ...
           HttpMessageHandler handler = null)
        {
            return _httpClients.GetOrAdd(baseAddress,
                             uri => new Lazy<System.Net.Http.HttpClient>(() =>
                             {
                                 ...
                                 var client = handler == null ? new System.Net.Http.HttpClient { BaseAddress = baseAddress } :
                                               new System.Net.Http.HttpClient(handler, disposeHandler: false) { BaseAddress = baseAddress };
        ...
        private static void setConnectionLeaseTimeout(Uri baseAddress, System.Net.Http.HttpClient client)
        {
        ...
        private static void setDefaultHeaders(IDictionary<string, string> defaultRequestHeaders, System.Net.Http.HttpClient client)
        {
        ...
        private static void setMaxResponseBufferSize(long? maxResponseContentBufferSize, System.Net.Http.HttpClient client)
        {
        ...
        private static void setRequestTimeout(TimeSpan? timeout, System.Net.Http.HttpClient client)
        {
            if (timeout.HasValue)
            {
